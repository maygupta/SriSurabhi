...
public class TextViewFontAllBold extends TextView {
    int textViewSize = 15;
    int textSize = 15;

    public TextViewFontAllBold(Context context) {
        super(context);
    ...
    public TextViewFontAllBold(Context context, AttributeSet attrs) {
        super(context, attrs);
        applyCustomFont(context);
        setTextSize(fontChange(context));
    ...
    public TextViewFontAllBold(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void applyCustomFont(Context context) {
        ...
        Typeface customFont = FontCacheBold.getTypeface("fonts/Roboto-Bold.ttf", context);
